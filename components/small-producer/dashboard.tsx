...
import { Droplets, TrendingDown, TrendingUp, AlertTriangle, Plus, LogOut, Cloud, Wind, Thermometer } from "lucide-react"
...
export function SmallProducerDashboard() {
    ...
    useEffect(() => {
        if (gardens && gardens.length > 0 && !selectedGarden) {
            setSelectedGarden(gardens[0]._id)
        }
    }, [gardens, selectedGarden])

    const currentGarden = gardens?.find((g) => g._id === selectedGarden)
                        ...
                        <DialogContent>
                            ...
                            <CropForm
                                onSuccess={() => {
                                    ...
                                    fetchGardens() // Refresh gardens list
                                }}
                            />
                        </DialogContent>
                    </Dialog>
